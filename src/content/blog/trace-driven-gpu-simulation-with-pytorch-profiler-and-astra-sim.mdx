...
import cuda_launch from "../../blog/trace-driven-gpu-simulation-with-pytorch-profiler-and-astra-sim/cuda_launch.webp";
...
def train(batch_data):
    ...
    images.cuda(), labels.cuda() = images.cuda(), labels.cuda()
