...
Despite being visually appealing, LaTeX and Microsoft Word can **create problems** with ATS parsers. Both programs **sacrifice parsability** for **visual appeal.**
...
As a practical example, a common criticism I will get of my resume is that it reads too **data-sciency**. Because I have built a couple of data-science projects over the years. Specifically, a lengthy post I wrote on [the International Science and Engineering Fair (ISEF)](https://www.linkedin.com/pulse/behind-innovation-insights-from-international-science-william-kaiser/).
...
All in all, this approach gives me flexibility in my resume. I can make it **data-sciency** or **quant**-y or **whatever** I want. 
...
Overall, this method is a good **antidote** to **LaTeX** for those who enjoy a typeset resume &mdash; without the ATS penalty.
